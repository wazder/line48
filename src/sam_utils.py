...
class SAMLineLogic:
    ...
    def detect_and_segment(self, frame: np.ndarray) -> Tuple[np.ndarray, List[Dict]]:
        ...
        for i, box in enumerate(boxes):
            ...
            if class_id in self.class_ids and confidence > 0.35:  # Balanced confidence for SAM
        ...
        for i, (detection, bbox) in enumerate(zip(detection_results, valid_boxes)):
            ...
            try:
                ...
                if len(masks) > 0:
                    ...
                    # Filter out very small masks (noise) - BALANCED
                    min_mask_area = 500  # Lowered from 1000 to 500 pixels
